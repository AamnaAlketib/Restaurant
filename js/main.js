...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoibW9vbnlvbmx5IiwiYSI6ImNrMHpoeTBpMTA1eGYzbnBnaHl3a2JtMDYifQ.94Ls68XTihmdRu-p3hzn2A',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  image.alt = `an image of the ${restaurant.name} restaurant`;
  li.append(image);
  ...
  li.append(textPart);
  textPart.append(name);

  const neighborhood = document.createElement('p');
  neighborhood.innerHTML = restaurant.neighborhood;
  textPart.append(neighborhood);
...
if('serviceWorker' in navigator){
  ...
  .then((reg) => console.log('Regestration worked!', reg))
  .catch((err)=> console.log('Regestraion faild ', err)) 
}
